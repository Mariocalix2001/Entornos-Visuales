...
Public Class conexion
    ...
    Public conexion As SqlConnection = New SqlConnection("Data Source= DESKTOP-G1O5PU1\SQLEXPRESS;Initial Catalog=TiendaIIIP; Integrated Security=True")
    ...
    Sub consultaDinamica(ByVal id As String, ByVal dgv As DataGridView)
        Try
            da = New SqlDataAdapter("Select * from usuario where idUsuario  like '" & "%" + id + "%" & "'", conexion)
            dt = New DataTable
            da.Fill(dt)
            dgv.DataSource = dt
        Catch ex As Exception
